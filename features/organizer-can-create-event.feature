...
Feature:
  ...
  Scenario: Member cannot create event
    Given I am logged in as "Jo Johnson"
    When I try to create a new event with title "Spring Drink-up" for organization "New York Developer Ninjas" with date "2018-04-24", description "During our spring break, we'll organize drink-ups only." in venue "Bar Goto, New York, United States"
